...
class TimelineRulesPropertiesTest {
    ...
    void validBounds_doNotThrow() {
        assertThatCode(() -> new TimelineRulesProperties(20, -20, 30, 0, 90, 30, 60))
                .doesNotThrowAnyException();
    }

    @Test
    void floorGreaterThanCeiling_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, 90, 0, 30, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void floorBelowZero_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, -1, 90, 30, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void ceilingAboveHundred_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, 0, 101, 30, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void narrowBand_breaksPairFeasibility_throws() {
        ...
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, 30, 50, 30, 40))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void wideCeilingNarrowFloor_breaksPairFeasibility_throws() {
        ...
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, 0, 40, 30, 35))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void nonPositivePushShift_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(0, -20, 30, 0, 90, 30, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void nonNegativeSuppressShift_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, 0, 30, 0, 90, 30, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void nonPositiveSwingShift_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 0, 0, 90, 30, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void bandLowMaxBelowZero_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, 0, 90, -1, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void bandMediumMaxNotGreaterThanBandLowMax_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, 0, 90, 60, 60))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void bandMediumMaxAboveHundred_throws() {
        assertThatThrownBy(() -> new TimelineRulesProperties(20, -20, 30, 0, 90, 30, 101))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
