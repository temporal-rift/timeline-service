...
class ParadoxResolutionPhaseOpenerTest {
    ...
    void open_phaseCreated_schedulesTimerAndReturnsItsPendingParadoxes() {
        var pending = List.of(new PendingParadox(UUID.randomUUID(), UUID.randomUUID(), 0));
    ...
    void open_phaseAlreadyExisted_doesNotScheduleAndReturnsExistingPendingParadoxes() {
        ...
        var proposedPending = List.of(new PendingParadox(UUID.randomUUID(), UUID.randomUUID(), 0));
        var existingPending = List.of(new PendingParadox(UUID.randomUUID(), UUID.randomUUID(), 0));
