...
/**
 * One event's terminal state within an {@code EraResolutionCompleted}.
 * {@code winningOutcomeId} is populated for {@code OUTCOME_APPLIED} and null for {@code CASCADED}/{@code STALLED} —
 * matching this codebase's flat-record-with-nullable-field convention. {@code STALLED} is distinct from
 * {@code CASCADED}: a {@code STALL} card is an ordinary disruption effect, not a paradox, and must
