...
/**
 * Private per-player reveal of one scanned {@code FutureEvent}'s current exact outcome state, published at
 * every round close for as long as the underlying SCAN entitlement stays active. {@code playerId} identifies
 * the viewer entitled to this message, not a card's actor — never broadcast. Not event-sourced.
 */
