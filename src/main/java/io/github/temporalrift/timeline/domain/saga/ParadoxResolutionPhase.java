...
/**
 * Persisted state for one era's paradox-resolution phase: one row per {@code (gameId, eraNumber)}, covering every
 * paradox detected in that era's resolution cycle behind a single
